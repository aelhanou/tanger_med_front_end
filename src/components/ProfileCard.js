    ...
    return (
        <Card>
            <div className="flex flex-wrap justify-center">
                ...
                <div className="flex justify-center items-center w-48 px-4 -mt-24">
                    {!email ? <SyncOutlined spin  size="large" /> : <Image src={`https://i.pravatar.cc/150?u=${email}`} rounded raised />}
                </div>
            ...
            <div className="text-center">
                <H5 color="gray">{lastname && lastname} {firstName && firstName}</H5>
